...
#### **Accuracy:** 
proportion of correct predictions out of all predictions; e.g., 80 correctly classified rows out of 100 gives 80% accuracy.
​
#### **Precision:** 
proportion of true positives among all predicted positives; measures how often “positive” predictions are actually correct.
​
#### **Recall:** 
proportion of true positives among all actual positives; measures how well the model finds all positive instances.
​
##### **F1 score:** 
harmonic mean of precision and recall, giving a single balanced score that is useful for imbalanced classes.
